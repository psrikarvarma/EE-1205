...
\begin{lstlisting}
$https://github.com/psrikarvarma/EE-1205/blob/main/codes/singing%2Csrikar.wav
\end{lstlisting}
\item 
\label{Python code}
A Python Code is written to achieve Audio Filtering 
\lstinputlisting{./codes/1,1.py}\label{prob:audio_filter_problem}
...
Sketch $y(n)$.\\
Solve\\
\solution  The C code calculates $y\brak{n}$ and generates values in a text file '$yn.txt$'.
\begin{lstlisting}
https://github.com/psrikarvarma/EE-1205/blob/main/codes/1,2.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/psrikarvarma/EE-1205/blob/main/codes/1,3.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/psrikarvarma/EE-1205/blob/main/codes/1,4.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/psrikarvarma/EE-1205/blob/main/codes/1,5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/psrikarvarma/EE-1205/blob/main/codes/1,6.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{figs/1,6.png}
...
%
\begin{lstlisting}
https://github.com/psrikarvarma/EE-1205/blob/main/codes/1,7.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figs/1,7.png}
...
\begin{lstlisting}
https://github.com/psrikarvarma/EE-1205/blob/main/codes/1,8.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/psrikarvarma/EE-1205/blob/main/codes/1,9.py  
\end{lstlisting}
This code verifies the result by plotting the obtained result with the result obtained by IDFT.
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figs/1,9.png}
...
\begin{lstlisting}
https://github.com/psrikarvarma/EE-1205/blob/main/codes/1,10.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figs/1,10.png}
...
\begin{lstlisting}
https://github.com/psrikarvarma/EE-1205/blob/main/codes/1,11.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figs/1,11.png}
...
Now,
\begin{align}
a^{n}u\brak{n} \xleftrightarrow[]{\mathcal{Z}} \frac{1}{1-az^{-1}}
     \label{eq:res-1}\\
    \delta\brak{n-k} \xleftrightarrow[]{\mathcal{Z}} z^{-k}
     \label{eq:res-2}
\end{align}
...
\begin{lstlisting}
https://github.com/psrikarvarma/EE-1205/blob/main/codes/1,12.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/psrikarvarma/EE-1205/blob/main/codes/1,13.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=1\columnwidth]{figs/1,13.png}
...
\end{align}
\begin{lstlisting}
https://github.com/psrikarvarma/EE-1205/blob/main/codes/1,14.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=1\columnwidth]{figs/1,14.png}
...
\begin{lstlisting}
https://github.com/psrikarvarma/EE-1205/blob/main/codes/1,15.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=1\columnwidth]{figs/1,15.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figs/1,12.png}
...
\begin{lstlisting}
https://github.com/psrikarvarma/EE-1205/blob/main/codes/fft.c
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/psrikarvarma/EE-1205/blob/main/codes/fft.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/psrikarvarma/EE-1205/blob/main/codes/1,16.c
\end{lstlisting}
The below python code extracts the data from these text files and plots Time vs $n$ for comparison.
\begin{lstlisting}
https://github.com/psrikarvarma/EE-1205/blob/main/codes/1,17.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=1\columnwidth]{figs/1,17.png}
